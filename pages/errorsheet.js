...
const ErrorSheet = () => {
    ...
    if (!user.isPresent) return (
        <div className='container min-h-[80vh] mx-auto px-8 py-5'>
            ...
            <div className='min-h-[80vh] mx-auto px-8 py-5'>
                ...
                <main>
                    ...
                    <section className='mt-5 '>
                        ...
                        >
                            <div
                                className='flex items-center w-full justify-between p-5 border border-theme-ferrari-red rounded-2xl shadow-md cursor-pointer transition-all hover:shadow-lg'
                                onClick={() => router.push(`/errorsheet/${id}`)}
                            >
